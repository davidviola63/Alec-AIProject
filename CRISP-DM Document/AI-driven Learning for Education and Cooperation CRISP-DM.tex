...
\title{AI-driven Learning for Education and Cooperation (Alec) - 1° Fase \\
\large Business Understanding utilizzando il protocollo CRISP-DM per progetti Machine Learning.}
\author{Davide Viola}
...
\begin{document}
	...
	In totale sono stati raccolti \textbf{26} documenti che rappresentano la base di conoscenza iniziale del progetto Alec.
